...
Type-safe, functional visualization layer for exploring conversation
graphs, artifact lifecycles, and multi-project categorization.
...
* *AffineScript* 11+ - Type-safe functional language compiling to
JavaScript
...
Documentation]
* https://affinescript-lang.org/docs/react/latest/introduction[AffineScript
React]
* https://reagraph.dev/[Reagraph]
* https://github.com/minnozz/affinescript-recharts[affinescript-recharts]
...
[arabic]
. Create Reagraph bindings
. Implement ConversationGraph component
. Build ArtifactTimeline with affinescript-recharts

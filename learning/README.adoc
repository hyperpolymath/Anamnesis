...
RDF manipulation, graph processing, reservoir computing, and
knowledge-augmented neural networks for Anamnesis analytics.
...
* https://github.com/JuliaGraphs/Serd.jl[Serd.jl]
* https://jmlr.org/papers/v23/21-0945.html[ReservoirComputing.jl Paper]
* https://arxiv.org/abs/2412.06354[GraphNeuralNetworks.jl]
...
[arabic]
. Implement RDF serialization module
. Create SPARQL client
. Build RDF→MetaGraph converter
. Implement basic ESN training
. Create KBANN prototype
. Integrate with Elixir via port
. Test on proving-ground data

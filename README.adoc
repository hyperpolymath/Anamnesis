...
└────────────────────────┬────────────────────────────────────────┘
                         ...
                         ▼
┌─────────────────────────────────────────────────────────────────┐
│  Visualization (AffineScript): Reagraph graphs, timeline charts,   │
...
| *Visualization* | AffineScript + React | Type safety, functional paradigm, eventual JS replacement |

=== Critical Constraints

- ❌ *NO PYTHON* - Use Julia for all scientific computing
- ✅ *Type safety* throughout (OCaml, AffineScript, Elixir typespecs)
...
= 6. Build visualization (AffineScript)
...
- [x] AffineScript domain types and color mixing
...
2. ✅ Research tech options (Julia RDF, reservoir computing, AffineScript viz, OCaml parsers, λProlog)
...
- [ ] Virtuoso storage integration
- [ ] Simple graph visualization (AffineScript)
...
anamnesis:conv:123 anamnesis:belongsTo anamnesis:proj:affinescript-evangeliser ;
                   anamnesis:membershipStrength 0.3 .
```

Visualized via color mixing: 80% green (Anamnesis) + 30% orange (AffineScript) = blended color.
...
- *Research*: `/docs/research/` - Tech stack evaluations:
  ...
  - `affinescript-visualization.adoc` - Reagraph, affinescript-recharts
...
- *AffineScript Evangeliser* - Learning curve synergies

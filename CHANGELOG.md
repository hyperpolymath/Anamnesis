...
- 6 comprehensive research reports (AsciiDoc format):
  ...
  - AffineScript Visualization Ecosystem (Reagraph, affinescript-recharts)
...
- AffineScript compiler and npm configuration
...
- Type safety via OCaml, Elixir typespecs, AffineScript, Julia type annotations

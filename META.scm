...
(define architecture-decisions
  '((adr-001
     ...
     (status . "accepted")
     (date . "2025-12-15")
     (context . "*A conversation knowledge extraction and reconciliation system for multi-LLM development workflows.*")
...
(define development-practices
  '((code-style
     (languages . ("Dune" "Elixir" "Julia" "Just" "OCaml" "ReScript" "Scheme" "Shell"))
